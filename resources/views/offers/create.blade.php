...
@section('layout')
    ...
    <div class="specifics-full2-container-ressource">
        <h1>Création des offres</h1>
        <div class="specifics-full-container-ressource">
        
            <form action="{{ route('createOffers.process') }}" method="POST" enctype="multipart/form-data">
                @csrf
                @if ($errors->any())
                ...
                <div class="ressource-container-">
                    <input type="text" name="name"  placeholder="Nom de la formation">
